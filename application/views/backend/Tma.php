...
<div class="row">
                    ...
                    <div class="btn-group dropdown" >
                        ...
                        <div class="dropdown-menu dropdown-menu-scale"  id="pos">
                            <?php foreach ($pos as $itempos) { ?>
                               <a class="dropdown-item" id='item' href="<?php echo site_url('backend/tma?id=').$itempos->id_pos ?>"><?php echo $itempos->nama_pos; ?></a>                                
                            <?php } ?>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-sm-12">
      <div class="box">
        ...
        <div class="box-body">              
	<iframe SRC=<?php echo base_url('backend/tma/grid/').$_GET['id'];?> width=100% height="500" frameBorder="0"></iframe>          
        </div>
      </div>
    </div>
