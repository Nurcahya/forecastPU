...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url(); ?>libs/jquery/datetimepicker/css/bootstrap-datetimepicker.min.css" type="text/css" />
                            ...
                            <ul class="nav" ui-nav>
                                ...
                                <li>
                                    <a href='<?php echo site_url('backend/citra?id=1') ?>'>
                                        ...
                                        <span class="nav-text">Citra Kamera</span>
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a href='<?php echo site_url('backend/reader') ?>' >
                                        ...
                                        <span class="nav-text">File CSV</span>
                                    </a>
                                </li>
                            ...
                            <ul class="nav navbar-nav mr-auto">
                                <li class="nav-item dropdown">
                                    <a class="nav-link" href data-toggle="dropdown">
                                        <h3><strong>Halaman Administrator - Aplikasi Monitoring Sungai Saddang</strong></h3>
                                    </a>
                                </li>
                            </ul>
